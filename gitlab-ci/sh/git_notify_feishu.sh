#!/bin/bash
#--------------------------------------------
# shell 提取git提交记录发送飞书版本
# author：yang.guo
#--------------------------------------------

# ！！！！module路径，需要git
gitProjectPath="/Users/axl/AndroidStudioProjects/NewPengPeng/app"
# ！！！！这是是需要修改的记录上次打印提交的commitid
lastCommitIdFilePath="/Users/axl/AndroidStudioProjects/NewPengPeng/lamourCommitHistory"
# 下载路径前缀
dowloadPreUrl="https://g-cdn.upliveapp.com/background/dhn_android/apk/Lamour/test"
# 二维码名称
qrFileName="qr.png"
# 飞书机器人webhook
